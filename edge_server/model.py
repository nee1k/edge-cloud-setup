...
model_mapping = {
    "neelk_googlenet_1.0-model": "googlenet",
    "neelk_resnet152_1.0-model": "resnet152",
    "neelk_shufflenet_2.0-model": "shufflenet_v2_x0_5",
    "neelk_densenet201_1.0-model": "densenet201",
    "neelk_mobilenet_3.0-model": "mobilenet_v3_small",
    "neelk_resnext50_1.0-model": "resnext50_32x4d",
    "neelk_squeezenet_1.0-model": "squeezenet1_1",
    "neelk_alexnet_1.0-model": "alexnet",
    "neelk_mobilenet_2.0-model": "mobilenet_v2",
    "neelk_resnet18_1.0-model": "resnet18"
}

class ModelStore:
    def __init__(self):
        self.model_index = 0
        self.current_model_id = "neelk_googlenet_1.0-model"
